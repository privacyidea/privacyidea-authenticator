...
public class Util {
     ...
     * @param userpartlength Number of bytes which shall be generated by the phone (default is 10)
     * @return A token with the combined secret (phone- and QR-part)
     */
    private static Token start2StepInit(Token token, int userpartlength) {
        ...
        byte[] phonepart = new byte[userpartlength];
        ...
        output = insertPeriodically(output, " ", 4);
        final AlertDialog alertDialog = new AlertDialog.Builder(mActivity).create();
        alertDialog.setTitle("Phone part of the secret for:\n" + token.getLabel());
